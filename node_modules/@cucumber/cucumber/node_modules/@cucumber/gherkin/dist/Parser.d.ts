...
export declare class Token implements IToken<TokenType> {
    ...
    constructor(line: GherkinLine, location: Location);
...
export declare enum RuleType {
    ...
    StepArg = 27,// StepArg := (DataTableAndMaybeDocString | DocStringAndMaybeDataTable)
    DataTableAndMaybeDocString = 28,// DataTableAndMaybeDocString := DataTable DocString?
    DocStringAndMaybeDataTable = 29,// DocStringAndMaybeDataTable := DocString DataTable?
    DataTable = 30,// DataTable! := #TableRow+
    DocString = 31,// DocString! := #DocStringSeparator #Other* #DocStringSeparator
    Tags = 32,// Tags! := #TagLine+
    DescriptionHelper = 33,// DescriptionHelper := #Empty* Description?
    Description = 34
}
export default class Parser<AstNode> {
    ...
    private matchTokenAt_51;
    private matchTokenAt_52;
    private matchTokenAt_53;
    private matchTokenAt_54;
    private match_EOF;
    private match_Empty;
